...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/26 17:04:15 by algalian          #+#    #+#             */
/*   Updated: 2024/03/26 17:04:16 by algalian         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	shortest_path(int *b, int *m)
{
	int	i;
	int	index;
	int	min;
...
void	total_cost(t_stacks *s, int *b, int n)
{
	...
	m[3] = ft_min(s->height_b - n, s->height_a - b[1])
		+ ft_abs((s->height_b - n) - (s->height_a - n));
	shortest_path(b, m);
}
